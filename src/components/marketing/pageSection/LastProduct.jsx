...
export default function LastProduct() {
  return (
    <div>
      <Container>
        <div className=' grid grid-cols-2 grid-rows-2 gap-8 w-full h-96 my-20 px-11 text-white uppercase'>

          <div className="group relative row-span-2 bg-yellow-500 w-full h-full rounded-xl p-7 overflow-hidden ">
          ...
          <div className="group relative bg-yellow-500 w-full h-full rounded-xl p-7 overflow-hidden">
            <div className='absolute z-10 top-0 left-0 rounded-xl h-full w-full bg-black opacity-20'></div>
          ...
          <div className="group relative bg-yellow-600 w-full h-full rounded-xl p-7 overflow-hidden">
            <div className='absolute z-10 top-0 left-0 rounded-xl h-full w-full bg-black opacity-20'></div>
